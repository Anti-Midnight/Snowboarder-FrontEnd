...
import SectionMarket from "views/Market/Sections/Market.js";
...
export default function EcommercePage() {
  ...
  const [snowboards, setSnowboards] = React.useState([]);

  const fetchSnowboards = () => {
    const url = process.env.REACT_APP_REST_API_LOCATION + "/snowboards/";
    fetch(url, {
      method: "GET",
  ...
  return (
    <div>
          ...
          <GridContainer>
            ...
            >
              <div className={classes.brand}>
                ...
                <h4>
                  Looking for a credible snowboard?{" "}
      ...
      <SectionMarket snowboards={snowboards} />
      </div>
